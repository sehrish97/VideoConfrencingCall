import { AppBar, Toolbar, Typography,styled,Box, InputBase, Avatar, Menu } from '@mui/material'
  ...
  return (
    <Box>
        <AppBar position='sticky'>
            <StyledToolbar>
                <Typography variant='h6' sx={{display:{xs:'none',sm:"block"}}}>VideoConferences</Typography>
                <DuoIcon sx={{display:{xs:'block',sm:"none"}}} />
                <Search>
